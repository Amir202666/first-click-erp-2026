...
export const ROUTE_TITLE_RULES: RouteTitleRule[] = [
  ...
  { path: '/customers/import', titleKey: 'customers.importTitle' },
  ...
  { path: '/vendors/import', titleKey: 'vendors.importTitle' },
  ...
  { path: '/items/import', titleKey: 'items.importTitle' },
  ...
  { path: '/promotions/report', titleKey: 'nav.promotionsReport' },
  { path: '/promotions/new', titleKey: 'nav.promotions' },
  { path: '/promotions', titleKey: 'nav.promotionsAndGifts' },
